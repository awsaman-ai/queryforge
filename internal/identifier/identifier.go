// Package identifier holds the physical-identifier safety rules: what shape a
// table or column name is allowed to have, and how to quote one for a SQL
// dialect. It is a leaf package (stdlib only) because both the config loader and
// the SQL generator have to agree on those rules exactly.
package identifier
